<?php
/**
 * The template for displaying gallery post
 *
 * @package WordPress
 * @subpackage goWatch
 * @since goWatch 1.0
			...
			<aside class="post-meta">
				<div class="post-meta-author">
					<?php
						...
						echo airkit_PostMeta::author( $post->ID, array('wrap' => 'div', 'prefix' => '<span class="post-author-avatar">' . airkit_get_avatar( $post->post_author, 50 ) . '</span>', 'postfix' => $date_published ) );
					?>
				</div>
				<div class="post-meta-actions">
					<?php
						echo airkit_PostMeta::add_to_favorite( $post->ID, array( 'label' => true, 'single' => 'y' ) );
						echo airkit_PostMeta::add_to_playlist( $post->ID, array( 'label' => true, 'single' => 'y' ) );
