		...
		<div class="row">
			<div class="airkit_table-content">
				<?php
					...
					echo airkit_Compilator::searchbox_element( array('style' => 'input', 'live_results' => 'y', 'align' => 'center', 'columns' => 'col-md-6 col-sm-6 cell-item') );
					echo airkit_Compilator::user_element( array('align' => 'right', 'columns' => 'col-md-3 col-sm-3 cell-item') );
				?>
			</div>
			<?php  ?>
		</div>
