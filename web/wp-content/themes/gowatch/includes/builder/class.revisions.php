...
class airkit_Post_Meta_Revisioning {
	...
	public function __construct() {
		...
		// Actions
		// When restoring a revision, also restore revisions's revisioned meta.
	...
	public function _wp_post_revision_meta_keys() {
		 ...
		 */
		return apply_filters( 'wp_post_revision_meta_keys', array( 'ts_template' ) );
	}
...
$airkit_Post_Meta_Revisioning = new airkit_Post_Meta_Revisioning;
