<?php
class airkit_widget_most_liked extends WP_Widget {

    function __construct() {
        $widget_ops = array( 'classname' => 'airkit_widget_most_liked' , 'description' => esc_html__( " Get posts that have the most likes." , 'gowatch' ) );
        parent::__construct( 'widget_touchsize_most_liked' , esc_html__( "Most liked posts" , 'gowatch' ) , $widget_ops );
    }
    ...
    function widget( $args , $instance ) {
        ...
        if( is_array($recent->posts) && !empty($recent->posts) ){
            ?>
            <ul class="widget-items row <?php echo ' widget-columns-' . $columns; ?>"><?php
