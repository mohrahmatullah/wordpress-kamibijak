	...
	if( is_user_logged_in() ) {
		...
		$dropdown = '<div class="user-dropdown text-left">
						...
						<ul class="user-menu">
							...
							<li class="profile">
								<a href="'. esc_url( $my_posts_url ) .'"><i class="icon-play"></i>'. esc_html__( 'My posts', 'gowatch' ) .'</a>
							</li>
							<li class="profile">
								<a href="'. esc_url( $favorites_url ) .'"><i class="icon-heart"></i>'. esc_html__( 'Favorites', 'gowatch' ) .'</a>
							</li>
							<li class="profile">
								<a href="'. esc_url( $my_playlists_url ) .'"><i class="icon-list-add"></i>'. esc_html__( 'My Playlists', 'gowatch' ) .'</a>
							</li>													
							<li class="settings">
